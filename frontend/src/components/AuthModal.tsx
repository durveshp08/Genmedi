...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, isFullScreen = false }) => {
  ...
  // Full-screen mode for login-first flow
  if (isFullScreen) {
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#f8f9ff]">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-[#e5eeff] overflow-hidden animate-in fade-in zoom-in-95">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#131b2e] to-[#1a2a45] px-6 py-5 text-white">
